...
router.get('/getclusters', groupValidator.validateGetCluster, groupCtrl.getClusters);

router.get('/getbasicgroupsinfo', groupCtrl.getBasicGroupsInfo);

router.get('/getComposeExample', groupCtrl.getComposeExample);
